...
namespace DiceGame.Network
{
    ...
    {
        [SerializeField] private NetworkPrefabRef roomPlayerInfoPrefab;
        ...
        public void OnPlayerJoined(NetworkRunner runner, PlayerRef player)
        {
            ...
            //if (networkRunnerPrefab.IsServer)
            //{
            //NetworkObject networkPlayerObject = networkRunnerPrefab.Spawn(roomPlayerInfoPrefab, Vector3.zero, Quaternion.identity, player);
            //}
        }
